...
python train.py --batch_size 8 --lr_bert 0.00001 --aug_scale --aug_crop --aug_translate --backbone vit_tiny --detr_model ../DETR-Models/detr_vit_tiny_for_transvg_embed_40_40.pth --bert_enc_num 12 --detr_enc_num 0 --hidden_dim 192 --dim_feedforward 768 --nheads 6 --dataset gref --max_query_len 40 --output_dir outputs/2022_03_04/refcocog_gsplit_vit_tiny --imsize 640 --epochs 90 --lr_drop 60 --bert_model bert-base-uncased --vision_stride 16
